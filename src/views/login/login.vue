    ...
    <div class="login-card">
      <div class="logo-svg">
        <svg id="Capa_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          <g id="XMLID_1123_">
            <path id="XMLID_849_" d="m234 310-144 41.045v-56.217l144-41.045z" fill="#a0c8ff"/>
            <g id="XMLID_1501_" fill="#a0c8ff">
              <circle id="XMLID_805_" cx="50" cy="462" r="40"/>
              <circle id="XMLID_883_" cx="194" cy="420.955" r="40"/>
            </g>
            <g id="XMLID_1407_" fill="#ff9b9b">
              <path id="XMLID_1025_" d="m397.592 96.306 104.408-30.089v-56.217l-104.408 30.089z"/>
              <circle id="XMLID_1026_" cx="357.592" cy="207.261" r="40"/>
            </g>
            <path id="XMLID_1315_"
      ...
      <el-form class="login-form" :model="loginForm" :rules="loginRules" ref="loginForm">
        <el-form-item prop="phone">
          <el-input v-model="loginForm.phone" placeholder="请输入网易云音乐手机号" prefix-icon="el-icon-mobile-phone"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button class="login-btn" type="primary" @click="handleSubmit('loginForm')" :loading="loginLoading">登录
          </el-button>
        </el-form-item>
      </el-form>
    </div>
